        ...
        if(this.state.hide){
            ...
            return (
                ...
                <View style={styles.container} >
                    <TouchableWithoutFeedback onPress={this._maskShoot.bind(this)}>
                    ...
                    translateY: this.state.offset.interpolate({
                     ...
                     outputRange: [height, (height-aHeight -34)]
                        ...
                        <TouchableHighlight ref="mybutton" style={styles.tipContentView} underlayColor='#f0f0f0'>
